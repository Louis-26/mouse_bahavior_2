...
DATASET="up_sample_dataset"
VIDEO_SEG_OUTPUT="video_segmentation_output_up"
STATS_OUTPUT="multi_video_results_up"
INFERENCE_DIR="preprocess_dataset_overall/up_sample_dataset"
CSV_EXPORT="CQ_4_export_up.csv"
